...
#generate first plot
with(filtered_data, plot(Date_Time,Global_active_power, type="l", 
                         ylab="Global Active Power",xlab=""))
#generate second plot

with (filtered_data, plot(Date_Time,Voltage, type="l",xlab="datetime"))
...
with (filtered_data, plot(Date_Time,Global_reactive_power, type="l", xlab="datetime"))
